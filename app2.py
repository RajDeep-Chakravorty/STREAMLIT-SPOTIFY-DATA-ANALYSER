...
st.markdown("<div style='position: fixed; top: 0px; right: 0px; background-color: white; color: red; padding: 5px; border-radius: 5px; z-index: 1000;'>Created By - RAJDEEP CHAKRAVORTY</div>", unsafe_allow_html=True)
