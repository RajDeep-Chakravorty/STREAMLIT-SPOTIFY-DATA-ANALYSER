...
st.markdown("<div style='position: absolute; top: 5px; right: 5px; background-color: white; color: red; padding: 5px;'>Created By - RAJDEEP CHAKRAVORTY</div>", unsafe_allow_html=True)
