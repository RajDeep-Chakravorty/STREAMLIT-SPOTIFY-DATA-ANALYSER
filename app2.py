...
# Title and caption
st.markdown("<div style='text-align: center;'><h1 style='font-size: 55px; color: #1DB954;'>Spotify Data Analyzer</h1><p style='font-size: 24px; color: black;'><i>Where words fail, music speaks.</i></p></div>", unsafe_allow_html=True)
