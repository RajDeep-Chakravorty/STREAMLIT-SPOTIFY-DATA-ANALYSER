...
# Title and caption
st.markdown("<div style='text-align: center;'><h1 style='font-size: 55px; color: #1DB954;'>Spotify Data Analyzer</h1><p style='font-size: 24px; color: magenta;'><i>Where words fail, music speaks.</i></p></div>", unsafe_allow_html=True)

# Introduction and instructions section
st.markdown('''
<div style='text-align: center;'>
<h2 style='font-size: 40px; color: red;'>Introduction</h2>
<p style='font-size: 20px;color: white;'>Welcome to the Spotify Data Analyzer, an automatic web app designed to analyze your Spotify listening history. Simply upload your Spotify data, and get insightful visualizations!</p>

<h2 style='font-size: 40px; color: red;'>How to Request Your Spotify Data</h2>
<p style='font-size: 20px; color: white;'>Open this <a href="https://www.spotify.com/de/account/privacy/" target="_blank" style='color: #1DB954;'>link</a> and sign in to your Spotify account<br>
